    ...
    <div className="text-gray-900" style={{ boxSizing: "border-box" }}>
      ...
      <div className="px-12 py-20 space-y-20 ">
        <div className="rounded-b-xl">
          <div className="flex">
            <div className="flex flex-col items-center">
              <div className="text-4.5xl font-medium px-2.5 tracking-wide">
                My Wishlist
              </div>
          ...
          <div className="grid grid-cols-3 px-8 py-16 gap-11">
            <div className="border">
              ...
              <div className="px-6 py-5 border-4 border-t-0">
                <div className="text-2xl font-medium text-center ">JAVA</div>
                ...
                <div className="mt-10 space-x-3">
                  <button className="px-8 py-2 text-xl text-center text-white bg-red-700 border">
                    Add to Cart
                  </button>
                  <button className="px-5 py-2 text-lg text-center border">
                    remove
                  </button>
                </div>
              </div>
